...
`}let l=c+`100% {${o(n,1-n)}}
}`,f=`__svelte_${BC(l)}_${a}`,p=Nc(e),{stylesheet:h,rules:d}=po.get(p)||LC(p,e);d[f]||(d[f]=!0,h.insertRule(`@keyframes ${f} ${l}`,h.cssRules.length));let y=e.style.animation||"";return e.style.animation=`${y?`${y}, `:""}${f} ${r}ms linear ${i}ms 1 both`,ho+=1,f}function go(e,t){let n=(e.style.animation||"").split(", "),r=n.filter(t?s=>s.indexOf(t)<0:s=>s.indexOf("__svelte")===-1),i=n.length-r.length;i&&(e.style.animation=r.join(", "),ho-=i,ho||GC())}function GC(){Mc(()=>{ho||(po.forEach(e=>{let{stylesheet:t}=e,n=t.cssRules.length;for(;n--;)t.deleteRule(n);e.rules={}}),po.clear())})}var Gi;function Li(e){Gi=e}function Wi(){if(!Gi)throw new Error("Function called outside component initialization");return Gi}function FC(e){Wi().$$.after_update.push(e)}function Cc(e){Wi().$$.on_destroy.push(e)}function Ji(){let e=Wi();return(t,n,{cancelable:r=!1}={})=>{let i=e.$$.callbacks[t];if(i){let s=O1(t,n,{cancelable:r});return i.slice().forEach(o=>{o.call(e,s)}),!s.defaultPrevented}return!0}}function Fi(e,t){return Wi().$$.context.set(e,t),t}function wn(e){return Wi().$$.context.get(e)}function P1(e,t){let n=e.$$.callbacks[t.type];n&&n.slice().forEach(r=>r.call(this,t))}var Bi=[],yo=[],uo=[],db=[],UC=Promise.resolve(),ic=!1;function VC(){ic||(ic=!0,UC.then(E1))}function ot(e){uo.push(e)}var rc=new Set,ao=0;function E1(){let e=Gi;do{for(;ao<Bi.length;){let t=Bi[ao];ao++,Li(t),zC(t.$$)}for(Li(null),Bi.length=0,ao=0;yo.length;)yo.pop()();for(let t=0;t<uo.length;t+=1){let n=uo[t];rc.has(n)||(rc.add(n),n())}uo.length=0}while(Bi.length);for(;db.length;)db.pop()();ic=!1,rc.clear(),Li(e)}function zC(e){if(e.fragment!==null){e.update(),Le(e.before_update);let t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(ot)}}var Ri;function qc(){return Ri||(Ri=Promise.resolve(),Ri.then(()=>{Ri=null})),Ri}function bn(e,t,n){e.dispatchEvent(O1(`${t?"intro":"outro"}${n}`))}var co=new Set,yt;function ce(){yt={r:0,c:[],p:yt}}function le(){yt.r||Le(yt.c),yt=yt.p}function P(e,t){e&&e.i&&(co.delete(e),e.i(t))}function x(e,t,n,r){if(e&&e.o){if(co.has(e))return;co.add(e),yt.c.push(()=>{co.delete(e),r&&(n&&e.d(1),r())}),e.o(t)}else r&&r()}var jc={duration:0};function k1(e,t,n){let r=t(e,n),i=!1,s,o,a=0;function u(){s&&go(e,s)}function c(){let{delay:f=0,duration:p=300,easing:h=Sc,tick:d=U,css:y}=r||jc;y&&(s=mo(e,0,1,p,f,h,y,a++)),d(0,1);let m=Tc()+f,b=m+p;o&&o.abort(),i=!0,ot(()=>bn(e,!0,"start")),o=Ic(g=>{if(i){if(g>=b)return d(1,0),bn(e,!0,"end"),u(),i=!1;if(g>=m){let O=h((g-m)/p);d(O,1-O)}}return i})}let l=!1;return{start(){l||(l=!0,go(e),Yt(r)?(r=r(),qc().then(c)):c())},invalidate(){l=!1},end(){i&&(u(),i=!1)}}}function A1(e,t,n){let r=t(e,n),i=!0,s,o=yt;o.r+=1;function a(){let{delay:u=0,duration:c=300,easing:l=Sc,tick:f=U,css:p}=r||jc;p&&(s=mo(e,1,0,c,u,l,p));let h=Tc()+u,d=h+c;ot(()=>bn(e,!1,"start")),Ic(y=>{if(i){if(y>=d)return f(0,1),bn(e,!1,"end"),--o.r||Le(o.c),!1;if(y>=h){let m=l((y-h)/c);f(1-m,m)}}return i})}return Yt(r)?qc().then(()=>{r=r(),a()}):a(),{end(u){u&&r.tick&&r.tick(1,0),i&&(s&&go(e,s),i=!1)}}}function mb(e,t,n,r){let i=t(e,n),s=r?0:1,o=null,a=null,u=null;function c(){u&&go(e,u)}function l(p,h){let d=p.b-s;return h*=Math.abs(d),{a:s,b:p.b,d,duration:h,start:p.start,end:p.start+h,group:p.group}}function f(p){let{delay:h=0,duration:d=300,easing:y=Sc,tick:m=U,css:b}=i||jc,g={start:Tc()+h,b:p};p||(g.group=yt,yt.r+=1),o||a?a=g:(b&&(c(),u=mo(e,s,p,d,h,y,b)),p&&m(0,1),o=l(g,d),ot(()=>bn(e,p,"start")),Ic(O=>{if(a&&O>a.start&&(o=l(a,d),a=null,bn(e,o.b,"start"),b&&(c(),u=mo(e,s,o.b,o.duration,0,y,i.css))),o){if(O>=o.end)m(s=o.b,1-s),bn(e,o.b,"end"),a||(o.b?c():--o.group.r||Le(o.group.c)),o=null;else if(O>=o.start){let I=O-o.start;s=o.a+o.d*y(I/o.duration),m(s,1-s)}}return!!(o||a)}))}return{run(p){Yt(i)?qc().then(()=>{i=i(),f(p)}):f(p)},end(){c(),o=a=null}}}function x1(e,t){let n={},r={},i={$$scope:1},s=e.length;for(;s--;){let o=e[s],a=t[s];if(a){for(let u in o)u in a||(r[u]=1);for(let u in a)i[u]||(n[u]=a[u],i[u]=1);e[s]=a}else for(let u in o)i[u]=1}for(let o in r)o in n||(n[o]=void 0);return n}function S1(e){return typeof e=="object"&&e!==null?e:{}}function L(e){e&&e.c()}function R(e,t,n,r){let{fragment:i,on_mount:s,on_destroy:o,after_update:a}=e.$$;i&&i.m(t,n),r||ot(()=>{let u=s.map(m1).filter(Yt);o?o.push(...u):Le(u),e.$$.on_mount=[]}),a.forEach(ot)}function B(e,t){let n=e.$$;n.fragment!==null&&(Le(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function KC(e,t){e.$$.dirty[0]===-1&&(Bi.push(e),VC(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function te(e,t,n,r,i,s,o,a=[-1]){let u=Gi;Li(e);let c=e.$$={fragment:null,ctx:null,props:s,update:U,not_equal:i,bound:fb(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(u?u.$$.context:[])),callbacks:fb(),dirty:a,skip_bound:!1,root:t.target||u.$$.root};o&&o(c.root);let l=!1;if(c.ctx=n?n(e,t.props||{},(f,p,...h)=>{let d=h.length?h[0]:p;return c.ctx&&i(c.ctx[f],c.ctx[f]=d)&&(!c.skip_bound&&c.bound[f]&&c.bound[f](d),l&&KC(e,f)),p}):[],c.update(),l=!0,Le(c.before_update),c.fragment=r?r(c.ctx):!1,t.target){if(t.hydrate){let f=RC(t.target);c.fragment&&c.fragment.l(f),f.forEach(S)}else c.fragment&&c.fragment.c();t.intro&&P(e.$$.fragment),R(e,t.target,t.anchor,t.customElement),E1()}Li(u)}var Z=class{$destroy(){B(this,1),this.$destroy=U}$on(t,n){let r=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return r.push(n),()=>{let i=r.indexOf(n);i!==-1&&r.splice(i,1)}}$set(t){this.$$set&&!TC(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}},Qn=[];function gb(e,t=U){let n,r=new Set;function i(a){if(ee(e,a)&&(e=a,n)){let u=!Qn.length;for(let c of r)c[1](),Qn.push(c,e);if(u){for(let c=0;c<Qn.length;c+=2)Qn[c][0](Qn[c+1]);Qn.length=0}}}function s(a){i(a(e))}function o(a,u=U){let c=[a,u];return r.add(c),r.size===1&&(n=t(i)||U),a(e),()=>{r.delete(c),r.size===0&&(n(),n=null)}}return{set:i,update:s,subscribe:o}}function Dc(e){let t=e-1;return t*t*t+1}function HC(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]]);return n}function yb(e,{delay:t=0,duration:n=400,easing:r=Dc,x:i=0,y:s=0,opacity:o=0}={}){let a=getComputedStyle(e),u=+a.opacity,c=a.transform==="none"?"":a.transform,l=u*(1-o);return{delay:t,duration:n,easing:r,css:(f,p)=>`
			transform: ${c} translate(${(1-f)*i}px, ${(1-f)*s}px);
			opacity: ${u-l*p}`}}function WC(e){var{fallback:t}=e,n=HC(e,["fallback"]);let r=new Map,i=new Map;function s(a,u,c){let{delay:l=0,duration:f=N=>Math.sqrt(N)*30,easing:p=Dc}=jt(jt({},n),c),h=u.getBoundingClientRect(),d=a.left-h.left,y=a.top-h.top,m=a.width/h.width,b=a.height/h.height,g=Math.sqrt(d*d+y*y),O=getComputedStyle(u),I=O.transform==="none"?"":O.transform,j=+O.opacity;return{delay:l,duration:Yt(f)?f(g):f,easing:p,css:(N,D)=>`
				opacity: ${N*j};
...
`)),e.$$.dirty&8&&(o||n(0,u=!1))},[u,i,s,o,a,r,c,l]}var hc=class extends Z{constructor(t){super(),te(this,t,Cq,Nq,ee,{key:1,value:2,isParentExpanded:3,isParentArray:4,expanded:0},Iq)}};function qq(e){let t=Object.prototype.toString.call(e).slice(8,-1);return t==="Object"?typeof e[Symbol.iterator]=="function"?"Iterable":e.constructor.name:t}function jq(e){let t,n,r;var i=e[6];function s(o){return{props:{key:o[0],value:o[1],isParentExpanded:o[2],isParentArray:o[3],nodeType:o[4],valueGetter:o[5]}}}return i&&(t=new i(s(e))),{c(){t&&L(t.$$.fragment),n=at()},m(o,a){t&&R(t,o,a),M(o,n,a),r=!0},p(o,[a]){let u={};if(a&1&&(u.key=o[0]),a&2&&(u.value=o[1]),a&4&&(u.isParentExpanded=o[2]),a&8&&(u.isParentArray=o[3]),a&16&&(u.nodeType=o[4]),a&32&&(u.valueGetter=o[5]),i!==(i=o[6])){if(t){ce();let c=t;x(c.$$.fragment,1,0,()=>{B(c,1)}),le()}i?(t=new i(s(o)),L(t.$$.fragment),P(t.$$.fragment,1),R(t,n.parentNode,n)):t=null}else i&&t.$set(u)},i(o){r||(t&&P(t.$$.fragment,o),r=!0)},o(o){t&&x(t.$$.fragment,o),r=!1},d(o){o&&S(n),t&&B(t,o)}}}function Dq(e,t,n){let r,i,s,{key:o,value:a,isParentExpanded:u,isParentArray:c}=t;function l(p){switch(p){case"Object":return oc;case"Error":return hc;case"Array":return ac;case"Iterable":case"Map":case"Set":return typeof a.set=="function"?lc:uc;case"MapEntry":return fc;default:return pc}}function f(p){switch(p){case"Object":case"Error":case"Array":case"Iterable":case"Map":case"Set":case"MapEntry":case"Number":return;case"String":return h=>`"${h}"`;case"Boolean":return h=>h?"true":"false";case"Date":return h=>h.toISOString();case"Null":return()=>"null";case"Undefined":return()=>"undefined";case"Function":case"Symbol":return h=>h.toString();default:return()=>`<${p}>`}}return e.$$set=p=>{"key"in p&&n(0,o=p.key),"value"in p&&n(1,a=p.value),"isParentExpanded"in p&&n(2,u=p.isParentExpanded),"isParentArray"in p&&n(3,c=p.isParentArray)},e.$$.update=()=>{e.$$.dirty&2&&n(4,r=qq(a)),e.$$.dirty&16&&n(6,i=l(r)),e.$$.dirty&16&&n(5,s=f(r))},[o,a,u,c,r,s,i]}var Ui=class extends Z{constructor(t){super(),te(this,t,Dq,jq,ee,{key:0,value:1,isParentExpanded:2,isParentArray:3})}};function Rq(e){de(e,"svelte-773n60","ul.svelte-773n60{--string-color:var(--json-tree-string-color, #cb3f41);--symbol-color:var(--json-tree-symbol-color, #cb3f41);--boolean-color:var(--json-tree-boolean-color, #112aa7);--function-color:var(--json-tree-function-color, #112aa7);--number-color:var(--json-tree-number-color, #3029cf);--label-color:var(--json-tree-label-color, #871d8f);--arrow-color:var(--json-tree-arrow-color, #727272);--null-color:var(--json-tree-null-color, #8d8d8d);--undefined-color:var(--json-tree-undefined-color, #8d8d8d);--date-color:var(--json-tree-date-color, #8d8d8d);--li-identation:var(--json-tree-li-indentation, 1em);--li-line-height:var(--json-tree-li-line-height, 1.3);--li-colon-space:0.3em;font-size:var(--json-tree-font-size, 12px);font-family:var(--json-tree-font-family, 'Courier New', Courier, monospace)}ul.svelte-773n60 li{line-height:var(--li-line-height);display:var(--li-display, list-item);list-style:none}ul.svelte-773n60,ul.svelte-773n60 ul{padding:0;margin:0}")}function Bq(e){let t,n,r;return n=new Ui({props:{key:e[0],value:e[1],isParentExpanded:!0,isParentArray:!1}}),{c(){t=A("ul"),L(n.$$.fragment),k(t,"class","svelte-773n60")},m(i,s){M(i,t,s),R(n,t,null),r=!0},p(i,[s]){let o={};s&1&&(o.key=i[0]),s&2&&(o.value=i[1]),n.$set(o)},i(i){r||(P(n.$$.fragment,i),r=!0)},o(i){x(n.$$.fragment,i),r=!1},d(i){i&&S(t),B(n)}}}function Lq(e,t,n){Fi(tr,{});let{key:r="",value:i}=t;return e.$$set=s=>{"key"in s&&n(0,r=s.key),"value"in s&&n(1,i=s.value)},[r,i]}var wo=class extends Z{constructor(t){super(),te(this,t,Lq,Bq,ee,{key:0,value:1},Rq)}};function Gq(e){de(e,"svelte-jvfq3i",".svelte-jvfq3i{box-sizing:border-box}section.switcher.svelte-jvfq3i{position:sticky;bottom:0;transform:translateY(20px);margin:40px -20px 0;border-top:1px solid #999;padding:20px;background:#fff}label.svelte-jvfq3i{display:flex;align-items:baseline;gap:5px;font-weight:bold}select.svelte-jvfq3i{min-width:140px}")}function Nb(e,t,n){let r=e.slice();return r[7]=t[n],r[9]=n,r}function Cb(e){let t,n,r,i,s,o,a=e[1],u=[];for(let c=0;c<a.length;c+=1)u[c]=qb(Nb(e,a,c));return{c(){t=A("section"),n=A("label"),r=Y(`Client
      
      `),i=A("select");for(let c=0;c<u.length;c+=1)u[c].c();k(i,"id",T1),k(i,"class","svelte-jvfq3i"),e[2]===void 0&&ot(()=>e[6].call(i)),k(n,"class","svelte-jvfq3i"),k(t,"class","switcher svelte-jvfq3i")},m(c,l){M(c,t,l),w(t,n),w(n,r),w(n,i);for(let f=0;f<u.length;f+=1)u[f].m(i,null);fo(i,e[2]),s||(o=[Q(i,"change",e[3]),Q(i,"change",e[6])],s=!0)},p(c,l){if(l&2){a=c[1];let f;for(f=0;f<a.length;f+=1){let p=Nb(c,a,f);u[f]?u[f].p(p,l):(u[f]=qb(p),u[f].c(),u[f].m(i,null))}for(;f<u.length;f+=1)u[f].d(1);u.length=a.length}l&4&&fo(i,c[2])},d(c){c&&S(t),$e(u,c),s=!1,Le(o)}}}function qb(e){let t,n,r,i=JSON.stringify(e[7].playerID)+"",s,o,a=JSON.stringify(e[7].matchID)+"",u,c,l=e[7].game.name+"",f,p;return{c(){t=A("option"),n=Y(e[9]),r=Y(` \u2014
            playerID: `),s=Y(i),o=Y(`,
            matchID: `),u=Y(a),c=Y(`
            (`),f=Y(l),p=Y(`)
