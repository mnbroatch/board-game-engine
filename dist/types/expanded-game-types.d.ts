import type { BagelGame, ConditionContainsSame as AuthoredConditionContainsSame, ConditionHasLine as AuthoredConditionHasLine, ConditionIsFull as AuthoredConditionIsFull, ConditionNoPossibleMoves as AuthoredConditionNoPossibleMoves, ConditionPosition as AuthoredConditionPosition, ConditionShorthandEntityType as AuthoredConditionShorthandEntityType, ConditionShorthandString as AuthoredConditionShorthandString, EndRule as AuthoredEndRule, Entity, EntityLineTargetRef as AuthoredEntityLineTargetRef, EntityMatcher, GridValueRef as AuthoredGridValueRef, PhaseConfig as AuthoredPhaseConfig, SetActivePlayersOptions, StateUpdate, TurnConfig as AuthoredTurnConfig, ValueRef } from "./bagel-types.js";
 ...
 */
export type Condition = AuthoredConditionShorthandString | AuthoredConditionShorthandEntityType | ConditionHasLine | ConditionIsFull | AuthoredConditionNoPossibleMoves | AuthoredConditionPosition | AuthoredConditionContainsSame | ConditionIs | ConditionContains | ConditionNot | ConditionOr | ConditionSome | ConditionEvery | ConditionInLine | ConditionEvaluate | ConditionWould;
 ...
 */
export type GameRules = Omit<AuthoredGameRules, "entities" | "turn" | "initialPlacements" | "endIf" | "phases" | "moves" | "initialMoves"> & {
    entities: Entity[];
    turn: TurnConfig;
    endIf?: EndRule[];
...
//# sourceMappingURL=expanded-game-types.d.ts.map