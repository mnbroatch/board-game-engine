...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.layout{text-align:center}.layout__shared-board{display:inline-flex;align-items:center;border:4px solid black;padding:5px;margin:4px}.board--grid{border:2px solid black;padding:3px}.grid__row{display:flex}.grid__space{border:1px solid black;height:50px;margin:1px;padding:1px;width:50px}.piece--blah{box-sizing:border-box;font-size:.6em;height:100%;margin-left:3px}.piece--blah--selected,.piece--blah--selected:focus{border:2px solid red;outline:none}.board--stack{display:inline-block}.board--grid{display:inline-block}`, ""]);
// Exports
...
var Serializable = /*#__PURE__*/function () {
  function Serializable() {
    ...
    this.args = JSON.parse(JSON.stringify(Array.prototype.slice.call(arguments)));
  }
...
function space_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, space_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
var Space = /*#__PURE__*/function (_Serializable) {
  function Space(coordinates) {
    ...
    _defineProperty(_this, "coordinates", void 0);
    _defineProperty(_this, "pieces", void 0);
    _this.coordinates = coordinates;
    _this.pieces = startingPieces;
    return _this;
  }
  _inherits(Space, _Serializable);
...
function grid_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, grid_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
var FLIPPED_ROTATION = 180;
var Grid = /*#__PURE__*/function (_Board) {
  ...
  return _createClass(Grid, [{
    ...
    key: "getPieces",
    value: function getPieces(target) {
...
function makeGrid(boardRule) {
  var x = boardRule.width;
  var y = boardRule.height;
  if (!x || !y) {
...
var matches = __webpack_require__(1505);
var matches_default = /*#__PURE__*/__webpack_require__.n(matches);
;// ./src/engine/condition/condition.js





function condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
var Condition = /*#__PURE__*/function (_Serializable) {
  ...
  _inherits(Condition, _Serializable);
...
;// ./src/engine/utils/resolve-board.ts
...
;// ./src/engine/condition/does-not-contain-condition.js





function does_not_contain_condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, does_not_contain_condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function does_not_contain_condition_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (does_not_contain_condition_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }



var DoesNotContainCondition = /*#__PURE__*/function (_Condition) {
  function DoesNotContainCondition() {
    _classCallCheck(this, DoesNotContainCondition);
    return does_not_contain_condition_callSuper(this, DoesNotContainCondition, arguments);
  }
  _inherits(DoesNotContainCondition, _Condition);
  return _createClass(DoesNotContainCondition, [{
    key: "isMet",
    value: function isMet(actionPayload) {
    ...
    key: "filterPieces",
    value: function filterPieces(piece) {
      return this.rules.piece === "any" || matches(piece, this.rules.piece || {});
    }
  }]);
}(Condition);

;// ./src/engine/condition/contains-condition.js





function contains_condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, contains_condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function contains_condition_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (contains_condition_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }


var ContainsCondition = /*#__PURE__*/function (_Condition) {
  function ContainsCondition() {
    _classCallCheck(this, ContainsCondition);
    return contains_condition_callSuper(this, ContainsCondition, arguments);
  }
...
;// ./src/engine/condition/bingo-condition.js





function bingo_condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, bingo_condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function bingo_condition_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (bingo_condition_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }


var BingoCondition = /*#__PURE__*/function (_Condition) {
  function BingoCondition() {
    _classCallCheck(this, BingoCondition);
    return bingo_condition_callSuper(this, BingoCondition, arguments);
  }
  _inherits(BingoCondition, _Condition);
  return _createClass(BingoCondition, [{
    key: "isMet",
    value: function isMet() {
      ...
      for (var _i2 = 0; _i2 < size; _i2++) {
        diagonal1.push(grid[_i2][_i2]);
        diagonal2.push(grid[_i2][size - 1 - _i2]);
      }
    ...
    value: function checkLine(line) {
      ...
      return line.every(function (space) {
        return space.pieces.some(function (piece) {
          return piece.doesRuleMatch(_this.rules.piece);
        });
      });
    }
  }]);
...
;// ./src/engine/condition/blackout-condition.js





function blackout_condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, blackout_condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function blackout_condition_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (blackout_condition_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }


var BlackoutCondition = /*#__PURE__*/function (_Condition) {
  function BlackoutCondition() {
    _classCallCheck(this, BlackoutCondition);
    return blackout_condition_callSuper(this, BlackoutCondition, arguments);
  }
  _inherits(BlackoutCondition, _Condition);
  return _createClass(BlackoutCondition, [{
    key: "isMet",
    value: function isMet() {
      var grid = resolveBoard(this.rules.boardPath, this.game).grid;
...
;// ./src/engine/condition/some-condition.js





function some_condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, some_condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function some_condition_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (some_condition_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }

var SomeCondition = /*#__PURE__*/function (_Condition) {
  function SomeCondition() {
    _classCallCheck(this, SomeCondition);
    return some_condition_callSuper(this, SomeCondition, arguments);
  }
  _inherits(SomeCondition, _Condition);
  return _createClass(SomeCondition, [{
    key: "isMet",
    value: function isMet() {
      return this.rules.conditions.some(function (c) {
        return new Condition(c).isMet();
      });
    }
  }]);
}(Condition);

;// ./src/engine/condition/relative-move-condition.js





function relative_move_condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, relative_move_condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function relative_move_condition_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (relative_move_condition_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }


var RelativeMoveCondition = /*#__PURE__*/function (_Condition) {
  function RelativeMoveCondition() {
    _classCallCheck(this, RelativeMoveCondition);
    return relative_move_condition_callSuper(this, RelativeMoveCondition, arguments);
  }
  _inherits(RelativeMoveCondition, _Condition);
  return _createClass(RelativeMoveCondition, [{
    key: "isMet",
    value: function isMet(actionPayload) {
      var board = this.game.get(actionPayload.board);
      var pieces = board.getPieces(actionPayload.target);
...
;// ./src/engine/condition/action-type-matches-condition.js





function action_type_matches_condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, action_type_matches_condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function action_type_matches_condition_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (action_type_matches_condition_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }

var ActionTypeMatchesCondition = /*#__PURE__*/function (_Condition) {
  function ActionTypeMatchesCondition() {
    _classCallCheck(this, ActionTypeMatchesCondition);
    return action_type_matches_condition_callSuper(this, ActionTypeMatchesCondition, arguments);
  }
  _inherits(ActionTypeMatchesCondition, _Condition);
  return _createClass(ActionTypeMatchesCondition, [{
    key: "isMet",
    value: function isMet(actionPayload) {
      var _actionPayload$action;
      return ((_actionPayload$action = actionPayload.actionRule) === null || _actionPayload$action === void 0 ? void 0 : _actionPayload$action.type) === this.rules.actionType;
    }
  }]);
}(Condition);

;// ./src/engine/condition/is-valid-player-condition.js





function is_valid_player_condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, is_valid_player_condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function is_valid_player_condition_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (is_valid_player_condition_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }

var IsValidPlayerCondition = /*#__PURE__*/function (_Condition) {
  function IsValidPlayerCondition() {
    _classCallCheck(this, IsValidPlayerCondition);
    return is_valid_player_condition_callSuper(this, IsValidPlayerCondition, arguments);
  }
  _inherits(IsValidPlayerCondition, _Condition);
  return _createClass(IsValidPlayerCondition, [{
    key: "isMet",
    value: function isMet(actionPayload) {
...
;// ./src/engine/utils/resolve-piece.ts
...
function resolvePiece(piece, gameState) {
  ...
  var pieceGroup = gameState.pieces.find(function (p) {
    var _piece$player;
...
;// ./src/engine/condition/piece-matches-condition.js
...
function piece_matches_condition_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, piece_matches_condition_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function piece_matches_condition_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (piece_matches_condition_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }



var PieceMatchesCondition = /*#__PURE__*/function (_Condition) {
  function PieceMatchesCondition() {
    _classCallCheck(this, PieceMatchesCondition);
    return piece_matches_condition_callSuper(this, PieceMatchesCondition, arguments);
  }
  _inherits(PieceMatchesCondition, _Condition);
  return _createClass(PieceMatchesCondition, [{
    key: "isMet",
    value: function isMet(actionPayload) {
...
;// ./src/engine/condition/condition-factory.js
...
function action_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, action_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
var Action = /*#__PURE__*/function (_Serializable) {
  function Action(rules, game) {
    ...
    _this.conditions = [].concat(invariantConditionRules, _toConsumableArray(_this.rules.conditions || [])).map(function (conditionRule) {
      return conditionFactory(conditionRule, game);
    });
    return _this;
  }
  _inherits(Action, _Serializable);
  return _createClass(Action, [{
    key: "assertIsValid",
    value: function assertIsValid(actionPayload) {
      var unmetConditions = this.conditions.filter(function (condition) {
        return !condition.isMet(actionPayload);
      });
...
var lodash_merge = __webpack_require__(5364);
;// ./src/engine/board/stack.js





function stack_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, stack_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
;// ./src/engine/board/board-factory.js
...
function player_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, player_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
var Player = /*#__PURE__*/function (_Serializable) {
  function Player(rule, index) {
    var _this;
    _classCallCheck(this, Player);
    _this = player_callSuper(this, Player, [rule, index]);
    _defineProperty(_this, "rule", void 0);
  ...
  _inherits(Player, _Serializable);
  return _createClass(Player);
}(Serializable);
/* harmony default export */ const player = (Player);
;// ./src/engine/action/move-piece-action.js





function move_piece_action_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, move_piece_action_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function move_piece_action_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (move_piece_action_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }



var MovePieceAction = /*#__PURE__*/function (_Action) {
  function MovePieceAction() {
    _classCallCheck(this, MovePieceAction);
    return move_piece_action_callSuper(this, MovePieceAction, arguments);
  }
  _inherits(MovePieceAction, _Action);
  return _createClass(MovePieceAction, [{
    key: "do",
...
;// ./src/engine/action/swap-action.js





function swap_action_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, swap_action_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function swap_action_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (swap_action_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }

var SwapAction = /*#__PURE__*/function (_Action) {
  function SwapAction() {
    _classCallCheck(this, SwapAction);
    return swap_action_callSuper(this, SwapAction, arguments);
  }
  _inherits(SwapAction, _Action);
  return _createClass(SwapAction, [{
    key: "do",
    value: function _do(actionPayload) {
      var piece;
      if (actionPayload.from === "player") {
        piece = this.game.players.find(function (player) {
          return player.id === actionPayload.playerId;
        }).pieces.find(function (piece) {
          return piece.name === actionPayload.piece.name;
        }).getOne();
      }
...
;// ./src/engine/action/select-piece-action.js





function select_piece_action_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, select_piece_action_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function select_piece_action_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (select_piece_action_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }

var SelectPieceAction = /*#__PURE__*/function (_Action) {
  function SelectPieceAction(actionPayload, game) {
    _classCallCheck(this, SelectPieceAction);
    return select_piece_action_callSuper(this, SelectPieceAction, [actionPayload, game]);
  }
  _inherits(SelectPieceAction, _Action);
  return _createClass(SelectPieceAction, [{
    key: "do",
    value: function _do(actionPayload) {
      var _actionPayload$piece;
      var piece;
      if ((_actionPayload$piece = actionPayload.piece) !== null && _actionPayload$piece !== void 0 && _actionPayload$piece.id) {
        var _actionPayload$piece2;
        piece = this.game.getPiece({
          id: (_actionPayload$piece2 = actionPayload.piece) === null || _actionPayload$piece2 === void 0 ? void 0 : _actionPayload$piece2.id
        });
...
;// ./src/engine/action/action-factory.js
...
;// ./src/engine/round/round.js





function round_createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = round_unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function round_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return round_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? round_arrayLikeToArray(r, a) : void 0; } }
function round_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function round_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, round_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
var Round = /*#__PURE__*/function (_Serializable) {
  ...
  return _createClass(Round, [{
    ...
    value: function getCorrectAction(actionPayload) {
      ...
      throw new Error("Invalid Action: ".concat(JSON.stringify(actionPayload)));
    }
  }, {
    key: "doAction",
...
;// ./src/engine/round/sequential-player-turn.js





function sequential_player_turn_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, sequential_player_turn_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function sequential_player_turn_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (sequential_player_turn_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }

var SequentialPlayerTurn = /*#__PURE__*/function (_Round) {
  function SequentialPlayerTurn(rules, game, options) {
    var _this;
    _classCallCheck(this, SequentialPlayerTurn);
    _this = sequential_player_turn_callSuper(this, SequentialPlayerTurn, [rules, game]);
    _this.currentPlayerIndex = (options === null || options === void 0 ? void 0 : options.firstPlayer) || 0;
    return _this;
  }
  _inherits(SequentialPlayerTurn, _Round);
  return _createClass(SequentialPlayerTurn, [{
    key: "afterDoAction",
    value: function afterDoAction() {
    ...
    value: function isOver() {
      var _this2 = this;
      return this.game.players.every(function (player) {
        return _this2.history.some(function (p) {
          return p === player;
        });
      });
    }
...
;// ./src/engine/round/round-factory.js
...
function piece_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, piece_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
function pile_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? pile_ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : pile_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function pile_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, pile_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
var Pile = /*#__PURE__*/function (_Serializable) {
  function Pile(pieceRule) {
    ...
    _this.pool = (pieceRule.variants ? Object.entries(pieceRule.variants) : []).reduce(function (acc, _ref) {
      ...
      return [].concat(_toConsumableArray(acc), _toConsumableArray(Array.from(Array(count)).map(function (_) {
...
function findValuePath(obj, compare) {
  ...
  var results = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new Set();
  ...
  if (_typeof(obj) === "object" && obj !== null) {
    for (var key in obj) {
      ...
      var result = findValuePath(obj[key], compare, newPath, visited, results);
      if (result.length) {
        results.add(currentPath);
      }
    }
...
function createInitialState(rules, options) {
  var _rules$initialPlaceme;
  expandRules(rules);
  var sharedBoard = Object.entries(rules.sharedBoard).reduce(function (acc, _ref) {
    var _ref2 = _slicedToArray(_ref, 2),
      id = _ref2[0],
      board = _ref2[1];
    return game_objectSpread(game_objectSpread({}, acc), {}, _defineProperty({}, id, boardFactory(game_objectSpread(game_objectSpread({}, board), {}, {
      path: ["sharedBoard", id]
    }), options)));
  }, {});
  var players = Array.from(Array(options.playerCount)).map(function (_, i) {
    return new player(rules.player, i);
  });
  var personalBoards = players.reduce(function (acc, player) {
    return game_objectSpread(game_objectSpread({}, acc), {}, _defineProperty({}, player.id, Object.entries(rules.personalBoard || []).reduce(function (acc, _ref3) {
      var _ref4 = _slicedToArray(_ref3, 2),
        id = _ref4[0],
        board = _ref4[1];
      return game_objectSpread(game_objectSpread({}, acc), {}, _defineProperty({}, id, boardFactory(game_objectSpread(game_objectSpread({}, board), {}, {
        path: ["sharedBoard", id]
      }), game_objectSpread(game_objectSpread({}, options), {}, {
        player: player
      }))));
    }, {})));
  }, {});
  var pieces = rules.pieces.reduce(function (acc, pieceRule) {
    if (pieceRule.perPlayer) {
      return [].concat(_toConsumableArray(acc), _toConsumableArray(players.map(function (player) {
        return new pile(pieceRule, {
          player: player
        });
      })));
    } else {
      return [].concat(_toConsumableArray(acc), [new pile(pieceRule)]);
    }
  }, []);
  ...
  var currentRound = roundFactory(currentRoundRule);
  return {
...
function expandActionPayload(move, state, rules) {
  ...
  var pieceName = ((_move$piece = move.piece) === null || _move$piece === void 0 ? void 0 : _move$piece.name) || "playerMarker";
  ...
  var expandedMove = game_objectSpread(game_objectSpread(game_objectSpread({}, defaultMove), move), {}, {
    piece: piece
  });
...
function makeMove(rules, options, _state, move) {
  ...
  var round = roundFactory(get_default()(rules, state.currentRound.rules.path), state);
  ...
  if (winner || isDraw) {
    game_objectSpread(game_objectSpread({}, state), {}, {
      gameOver: true,
      winner: winner
...
function normalizePath(path) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return path[0] === "personalBoard" && options.player ? ["personalBoards", options.player.id.toString()].concat(_toConsumableArray(path.slice(1))) : path;
}
...
function addPathToRules(rules) {
  ...
  if (rules.round && _typeof(rules.round) === 'object') {
...
var options = {
  playerCount: 2
}; //temp, refactor out once stable

function useGame(gameRules) {
  var _useState = (0,react.useState)(function () {
      return makeMove(gameRules, options);
    }),
...
/* harmony default export */ const game_context = (/*#__PURE__*/(0,react.createContext)());
;// ./src/components/piece/blah-piece.js


function Blah(_ref) {
  var piece = _ref.piece,
    onClick = _ref.onClick;
  var game = (0,react.useContext)(game_context);
  return /*#__PURE__*/react.createElement("button", {
    onClick: onClick,
    className: ["piece", "piece--blah", game.context.selectedPiece === piece && "piece--blah--selected"].filter(Boolean).join(" ")
  }, piece.rule.name !== "playerMarker" && /*#__PURE__*/react.createElement("div", null, piece.rule.name), piece.player && /*#__PURE__*/react.createElement("div", null, "P", piece.player.index), piece.rule.variantId && /*#__PURE__*/react.createElement("div", null, piece.rule.variantId));
}
;// ./src/components/piece/piece.js


function piece_Piece(props) {
  if (true) {
    return /*#__PURE__*/react.createElement(Blah, props);
  } else {}
}
...
var GridComponent = function GridComponent(_ref) {
  var board = _ref.board,
    onPieceClick = _ref.onPieceClick,
    onSpaceClick = _ref.onSpaceClick;
  return /*#__PURE__*/react.createElement("div", {
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      }, space.pieces.map(function (piece, j) {
        return /*#__PURE__*/react.createElement("div", {
          className: "grid__space-contents",
          key: j
        }, /*#__PURE__*/react.createElement(piece_Piece, {
          piece: piece,
          onClick: function onClick() {
...
/* harmony default export */ const grid = (GridComponent);
;// ./src/components/board/stack.js


function stack_Stack(_ref) {
  var board = _ref.board,
    onPieceClick = _ref.onPieceClick;
  return /*#__PURE__*/react.createElement("div", {
    className: "board--stack"
  }, board.stack.map(function (piece, i) {
    return /*#__PURE__*/react.createElement(piece_Piece, {
      piece: piece,
      onClick: function onClick() {
        onPieceClick === null || onPieceClick === void 0 || onPieceClick(piece);
      },
      key: i
    });
  }));
...
function Layout(_ref) {
  var game = _ref.game,
    onSpaceClick = _ref.onSpaceClick,
    onPieceClick = _ref.onPieceClick;
  var halfCount = Math.ceil(game.players.length / 2);
  return /*#__PURE__*/react.createElement("div", {
    className: "layout"
  }, !!game.personalBoards && /*#__PURE__*/react.createElement("div", null, game.players.slice(0, halfCount).map(function (player) {
    return /*#__PURE__*/react.createElement("div", {
      key: player.id,
      className: "layout__personal-board"
    }, Object.entries(game.personalBoards[player.id]).map(function (_ref2) {
      var _ref3 = _slicedToArray(_ref2, 2),
        key = _ref3[0],
        board = _ref3[1];
      return /*#__PURE__*/react.createElement(board_Board, {
        key: key,
        board: board,
    ...
    className: "layout__shared-board"
  }, Object.entries(game.sharedBoard).map(function (_ref4) {
  ...
  })), !!game.personalBoards && /*#__PURE__*/react.createElement("div", null, game.players.slice(halfCount).map(function (player) {
    return /*#__PURE__*/react.createElement("div", {
      key: player.id,
      className: "layout__personal-board"
    }, Object.entries(game.personalBoards[player.id]).map(function (_ref6) {
...
var App = function App() {
  var _useGame = useGame(tic_tac_toe_verbose_namespaceObject),
    _useGame2 = _slicedToArray(_useGame, 2),
    game = _useGame2[0],
  ...
  return /*#__PURE__*/react.createElement(game_context.Provider, {
    value: game
...
var cjs_js_styles = __webpack_require__(5392);
;// ./styles.css
...
var update = injectStylesIntoStyleTag_default()(cjs_js_styles/* default */.A, styles_options);
