...
export default function entityMatches(bgioArguments: BgioReadonlyState | BgioResolveState, matcher: MoveArgumentsState, entity: EngineEntity, context: ResolutionContext): boolean;
