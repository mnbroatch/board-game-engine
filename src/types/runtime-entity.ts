 ...
 */
export type GameEntityShapeMap = Record<
  string,
  { attributes: Record<string, unknown>; state?: Record<string, unknown> }
>;

export interface EngineEntityBase<
  TAttributes extends Record<string, unknown> = DefaultEngineEntityAttributes,
  TState extends Record<string, unknown> = DefaultEngineEntityState,
> {
  entityId: number;
...
export interface EngineSpaceEntity<
  TAttributes extends Record<string, unknown> = DefaultEngineEntityAttributes,
  TState extends Record<string, unknown> = DefaultEngineEntityState,
> extends EngineEntityBase<TAttributes, TState> {
...
export interface EngineSpaceGroupEntity<
  TAttributes extends Record<string, unknown> = DefaultEngineEntityAttributes,
  TState extends Record<string, unknown> = DefaultEngineEntityState,
> extends EngineEntityBase<TAttributes, TState> {
...
export type EngineEntity<
  ...
  TState extends Record<string, unknown> = DefaultEngineEntityState,
> =
  | EngineEntityBase<TAttributes, TState>
  | EngineSpaceEntity<TAttributes, TState>
  | EngineSpaceGroupEntity<TAttributes, TState>;

/** Entities that can act as containers in conditions (e.g. Contains/ContainsSame). */
export type EngineEntityContainer<
  TAttributes extends Record<string, unknown> = DefaultEngineEntityAttributes,
  TState extends Record<string, unknown> = DefaultEngineEntityState,
> = EngineSpaceEntity<TAttributes, TState> | EngineSpaceGroupEntity<TAttributes, TState>;
