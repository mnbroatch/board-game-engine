...
export type ResolvedConditionTyped =
  | ResolvedConditionHasLine
  | ResolvedConditionIsFull
  | ResolvedConditionNoPossibleMoves
  | ResolvedConditionPosition
  | ResolvedConditionContainsSame
  | ResolvedConditionIs
  | ResolvedConditionContains
  | ResolvedConditionNot
  | ResolvedConditionOr
  | ResolvedConditionSome
  | ResolvedConditionEvery
  | ResolvedConditionInLine
  | ResolvedConditionEvaluate
  | ResolvedConditionWould;

export type ResolvedConditionRule =
  | ResolvedConditionShorthandString
  | ResolvedConditionShorthandEntityType
  | ResolvedConditionTyped;
