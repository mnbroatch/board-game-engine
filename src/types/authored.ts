...
import type {
  BagelGame as AuthoredGameRules,
  MoveDefinition as AuthoredMoveDefinition,
  TurnConfig as AuthoredTurnConfig,
  PhaseConfig as AuthoredPhaseConfig,
  EndRule as AuthoredEndRule,
  InitialPlacement,
  Entity as AuthoredEntity,
...
export type ContextPathRef = Extract<ValueRef, { type: "contextPath" }>;
export type CtxPathRef = Extract<ValueRef, { type: "ctxPath" }>;
export type ExpressionRef = Extract<ValueRef, { type: "expression" }>;
export type CoordinatesRef = Extract<ValueRef, { type: "coordinates" | "Coordinates" }>;
export type RelativeCoordinatesRef = Extract<ValueRef, { type: "relativeCoordinates" }>;
